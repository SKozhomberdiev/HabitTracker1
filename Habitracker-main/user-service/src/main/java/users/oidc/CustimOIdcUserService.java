...
public class CustimOIdcUserService extends OidcUserService {
    ...
    private OidcUser processOAuth2User(OidcUserRequest userRequest, OidcUser oidcUser) {
        ...
        Optional<UserEntity> userOptional=userRepository.findByEmail(oidcUser.getEmail());
        UserEntity user;
    ...
    private UserEntity registerNewUser(OidcUserRequest userRequest, OidcUserInfo oidcUserInfo) {
    ...
    private UserEntity updateExistingUser(UserEntity existingUser, OidcUserInfo oidcUserInfo) {
